...
import { createStudioEnvironment } from "../shared/car-model.js?v=31";
import { applyCarToMesh, buildRaceCar } from "./race-car-view.js?v=33";
...
import { setupRaceCamera } from "./race-camera.js?v=33";
